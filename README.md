...
![Continuous Integration](https://github.com/hackariens/nuxtjs/actions/workflows/ci.yml/badge.svg?branch=develop)
...
```sh
git clone --recursive git@github.com:hackariens/nuxtjs.git nuxtjs
cd nuxtjs
```
